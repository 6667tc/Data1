...
from args import gnn_lstm_args_parser
...
def main():
    ...
    print(graph)
    # 若需重新训练请取消注释
    train2(args, Dtr, Val, model_type='gnn-lstm', path=path)
    test2(args, Dte, scaler, model_type='gnn-lstm', path=path)
